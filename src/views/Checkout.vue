<template>
  ...
  <p
    class="text-gray-900 font-semibold container mx-auto mb-6 text-sm sm:text-base"
  >
    <a href="#">2 batik akan segera dicheckout</a>
  </p>
  <div
    class="px-4 sm:px-10 lg:px-20 mt-5 container mx-auto p-6 bg-white shadow-xl rounded-lg"
  >
    <h2 class="text-xl sm:text-2xl font-bold mb-6">Produk Dipesan</h2>

    <div class="hidden sm:grid grid-cols-4 font-bold text-gray-800 mb-4">
      ...
      >
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-sm sm:text-md">Kondisi • {{ item.condition }}</p>
            <p class="text-sm sm:text-md">Ukuran • {{ item.size }}</p>
          </div>
        </div>
    ...
    >
      ...
      <input
        ...
        class="w-full sm:w-1/2 p-2 border rounded-lg text-sm"
      />
  ...
  <!-- Diskon / Promo -->
  <div
    class="px-20 mt-10 mb-20 container mx-auto p-6 bg-wwhite shadow-xl rounded-lg"
  >
  ...
  <div class="mt-10 mb-20 container mx-auto p-6 bg-white shadow-xl rounded-lg">
      ...
      <div>
        ...
        <div class="space-y-3">
          ...
          <div class="border-t pt-20 flex justify-between font-bold">
            <span>TOTAL</span>
            <span class="text-primary">Rp. 1.039.500</span>
          </div>
        </div>
